(function(E,f){typeof exports=="object"&&typeof module<"u"?f(exports,require("react/jsx-runtime"),require("react")):typeof define=="function"&&define.amd?define(["exports","react/jsx-runtime","react"],f):(E=typeof globalThis<"u"?globalThis:E||self,f(E.McpUiClient={},E.jsxRuntime,E.React))})(this,function(E,f,_){"use strict";var Ot=Object.defineProperty;var Fe=E=>{throw TypeError(E)};var Dt=(E,f,_)=>f in E?Ot(E,f,{enumerable:!0,configurable:!0,writable:!0,value:_}):E[f]=_;var F=(E,f,_)=>Dt(E,typeof f!="symbol"?f+"":f,_),le=(E,f,_)=>f.has(E)||Fe("Cannot "+_);var T=(E,f,_)=>(le(E,f,"read from private field"),_?_.call(E):f.get(E)),I=(E,f,_)=>f.has(E)?Fe("Cannot add the same private member more than once"):f instanceof WeakSet?f.add(E):f.set(E,_),Q=(E,f,_,q)=>(le(E,f,"write to private field"),q?q.call(E,_):f.set(E,_),_),g=(E,f,_)=>(le(E,f,"access private method"),_);var j,z,Y,K,J,je,G,V,S,ee,L,x,D,A,ce,Ye,de,Ge;const q={PREFERRED_FRAME_SIZE:"preferred-frame-size",INITIAL_RENDER_DATA:"initial-render-data"},ue="mcpui.dev/ui-";function Ve(r){let e;try{e=new URL(r)}catch(t){return console.error("Error parsing URL:",t),!1}return e.protocol==="http:"||e.protocol==="https:"}function We(r,e){if(r.mimeType!=="text/html"&&r.mimeType!=="text/uri-list")return{error:"Resource must be of type text/html (for HTML content) or text/uri-list (for URL content)."};if(r.mimeType==="text/uri-list"){let t="";if("text"in r&&typeof r.text=="string"&&r.text.trim()!=="")t=r.text;else if("blob"in r&&typeof r.blob=="string")try{t=new TextDecoder().decode(Uint8Array.from(atob(r.blob),o=>o.charCodeAt(0)))}catch(o){return console.error("Error decoding base64 blob for URL content:",o),{error:"Error decoding URL from blob."}}else return{error:"URL resource expects a non-empty text or blob field containing the URL."};if(t.trim()==="")return{error:"URL content is empty."};const n=t.split(`
`).map(o=>o.trim()).filter(o=>o&&!o.startsWith("#")&&Ve(o));if(n.length===0)return{error:"No valid URLs found in uri-list content."};n.length>1&&console.warn(`Multiple URLs found in uri-list content. Using the first URL: "${n[0]}". Other URLs ignored:`,n.slice(1));const s=n[0];if(e&&e.trim()!=="")try{const o=new URL(e);if(typeof window<"u"&&o.host===window.location.host)console.error("For security, the proxy origin must not be the same as the host origin. Using original URL instead.");else return o.searchParams.set("url",s),{iframeSrc:o.toString(),iframeRenderMode:"src"}}catch(o){console.error(`Invalid proxy URL provided: "${e}". Falling back to direct URL.`,o instanceof Error?o.message:String(o))}return{iframeSrc:s,iframeRenderMode:"src"}}else if(r.mimeType==="text/html"){let t="";if("text"in r&&typeof r.text=="string")t=r.text;else if("blob"in r&&typeof r.blob=="string")try{t=new TextDecoder().decode(Uint8Array.from(atob(r.blob),n=>n.charCodeAt(0)))}catch(n){return console.error("Error decoding base64 blob for HTML content:",n),{error:"Error decoding HTML content from blob."}}else return{error:"HTML resource requires text or blob content."};if(e&&e.trim()!=="")try{const n=new URL(e);if(typeof window<"u"&&n.host===window.location.host)console.error("For security, the proxy origin must not be the same as the host origin. Using srcDoc rendering instead.");else return n.searchParams.set("contentType","rawhtml"),{iframeSrc:n.toString(),iframeRenderMode:"src",htmlString:t}}catch(n){console.error(`Invalid proxy URL provided: "${e}". Falling back to srcDoc rendering.`,n instanceof Error?n.message:String(n))}return{htmlString:t,iframeRenderMode:"srcDoc"}}else return{error:"Unsupported mimeType. Expected text/html or text/uri-list."}}function He(r){if("text"in r&&typeof r.text=="string"&&r.text.trim()!=="")return{code:r.text};if("blob"in r&&typeof r.blob=="string")try{return{code:new TextDecoder().decode(Uint8Array.from(atob(r.blob),t=>t.charCodeAt(0)))}}catch(e){return console.error("Error decoding base64 blob for remote DOM content:",e),{error:"Error decoding remote DOM content from blob."}}return{error:"Remote DOM resource requires non-empty text or blob content."}}function pe(r){return r._meta??{}}function me(r){const e=pe(r),t={};return Object.entries(e).forEach(([n,s])=>{n.startsWith(ue)&&(t[n.slice(ue.length)]=s)}),t}const N={UI_MESSAGE_RECEIVED:"ui-message-received",UI_MESSAGE_RESPONSE:"ui-message-response",UI_SIZE_CHANGE:"ui-size-change",UI_LIFECYCLE_IFRAME_READY:"ui-lifecycle-iframe-ready",UI_LIFECYCLE_IFRAME_RENDER_DATA:"ui-lifecycle-iframe-render-data",UI_REQUEST_RENDER_DATA:"ui-request-render-data",UI_PROXY_IFRAME_READY:"ui-proxy-iframe-ready",UI_HTML_CONTENT:"ui-html-content"},qe={WAIT_FOR_RENDER_DATA:"waitForRenderData"},fe=({resource:r,onUIAction:e,style:t,proxy:n,iframeRenderData:s,autoResizeIframe:o,sandboxPermissions:a,iframeProps:u})=>{const l=_.useRef(null);_.useImperativeHandle(u==null?void 0:u.ref,()=>l.current);const{error:h,iframeSrc:i,iframeRenderMode:p,htmlString:d}=_.useMemo(()=>We(r,n),[r,n]),c=_.useMemo(()=>me(r),[r]),m=c[q.PREFERRED_FRAME_SIZE]??["100%","100%"],b=c[q.INITIAL_RENDER_DATA]??void 0,y=_.useMemo(()=>{if(!(!s&&!b))return{...b,...s}},[s,b]),v=_.useMemo(()=>{if(i&&y){const R=new URL(i);return R.searchParams.set(qe.WAIT_FOR_RENDER_DATA,"true"),R.toString()}return i},[i,y]),w=_.useCallback(R=>{var W;if(y){const O=R.currentTarget.contentWindow,C=v?new URL(v).origin:"*";U(N.UI_LIFECYCLE_IFRAME_RENDER_DATA,O,C,void 0,{renderData:y})}(W=u==null?void 0:u.onLoad)==null||W.call(u,R)},[y,v,u==null?void 0:u.onLoad]),P=_.useMemo(()=>p==="srcDoc"?he(a??"","allow-scripts"):he(a??"","allow-scripts allow-same-origin"),[a,p]);return _.useEffect(()=>{async function R(W){const{source:O,origin:C,data:M}=W;if(l.current&&O===l.current.contentWindow){if((M==null?void 0:M.type)===N.UI_PROXY_IFRAME_READY){p==="src"&&d&&(v!=null&&v.includes("contentType=rawhtml"))&&U(N.UI_HTML_CONTENT,O,C,void 0,{html:d,sandbox:P});return}if((M==null?void 0:M.type)===N.UI_LIFECYCLE_IFRAME_READY){y&&U(N.UI_LIFECYCLE_IFRAME_RENDER_DATA,O,C,void 0,{renderData:y});return}if((M==null?void 0:M.type)===N.UI_REQUEST_RENDER_DATA){U(N.UI_LIFECYCLE_IFRAME_RENDER_DATA,O,C,M.messageId,{renderData:y});return}if((M==null?void 0:M.type)===N.UI_SIZE_CHANGE){const{width:H,height:k}=M.payload;if(o&&l.current){const Nt=(typeof o=="boolean"||o.height)&&k,Pt=(typeof o=="boolean"||o.width)&&H;Nt&&(l.current.style.height=`${k}px`),Pt&&(l.current.style.width=`${H}px`)}return}const ae=M;if(!ae)return;if(e){const H=ae.messageId;U(N.UI_MESSAGE_RECEIVED,O,C,H);try{const k=await e(ae);U(N.UI_MESSAGE_RESPONSE,O,C,H,{response:k})}catch(k){console.error("Error handling UI action result in HTMLResourceRenderer:",k),U(N.UI_MESSAGE_RESPONSE,O,C,H,{error:k})}}}}return window.addEventListener("message",R),()=>window.removeEventListener("message",R)},[e,y,p,d,v,P]),h?f.jsx("p",{className:"text-red-500",children:h}):p==="srcDoc"?d==null?h?null:f.jsx("p",{className:"text-orange-500",children:"No HTML content to display."}):f.jsx("iframe",{srcDoc:d,sandbox:P,style:{width:m[0],height:m[1],...t},title:"MCP HTML Resource (Embedded Content)",...u,ref:l,onLoad:w}):p==="src"?v==null?h?null:f.jsx("p",{className:"text-orange-500",children:"No URL provided for HTML resource."}):f.jsx("iframe",{src:v,sandbox:P,style:{width:m[0],height:m[1],...t},title:"MCP HTML Resource (URL)",...u,ref:l,onLoad:w}):f.jsx("p",{className:"text-gray-500",children:"Initializing HTML resource display..."})};fe.displayName="HTMLResourceRenderer";function U(r,e,t,n,s){const o=t&&t!=="null"?t:"*";e==null||e.postMessage({type:r,messageId:n??void 0,payload:s},o)}function he(r,e){return[...new Set([...r.split(" "),...e.split(" ")])].filter(Boolean).map(t=>t.trim()).join(" ")}const _e=1,Ee=3,be=8,Be=9,$e=0,Ke=1,Ze=2,Xe=3,B=1,te=2,re=3,$="~";function ve({call:r,insertChild:e,removeChild:t,updateText:n,updateProperty:s}){const o={[$e]:e,[Ke]:t,[Ze]:n,[Xe]:s};return{call:r,mutate(a){for(const[u,...l]of a)o[u](...l)}}}class Je{constructor({retain:e,release:t,methods:n}={}){F(this,"root",{id:$,type:Be,children:[],version:0,properties:{},attributes:{},eventListeners:{}});F(this,"attached",new Map([[$,this.root]]));F(this,"subscribers",new Map);F(this,"parents",new Map);F(this,"implementations",new Map);const{attached:s,parents:o,subscribers:a}=this;this.connection=ve({call:(i,p,...d)=>{const c=this.implementations.get(i),m=c==null?void 0:c[p];if(typeof m!="function")throw new Error(`Node ${i} does not implement the ${p}() method`);return m(...d)},insertChild:(i,p,d)=>{const c=s.get(i),{children:m}=c,b=l(p,c);d===m.length?m.push(b):m.splice(d,0,b),c.version+=1,this.parents.set(p.id,c.id),u(c)},removeChild:(i,p)=>{const d=s.get(i),{children:c}=d,[m]=c.splice(p,1);m&&(d.version+=1,u(d),h(m))},updateProperty:(i,p,d,c=B)=>{const m=s.get(i);e==null||e(d);let b;switch(c){case B:b=m.properties;break;case te:b=m.attributes;break;case re:b=m.eventListeners;break}const y=b[p];b[p]=d,m.version+=1;let v;if(p==="slot"){const w=this.parents.get(i);v=w==null?w:s.get(w),v&&(v.version+=1)}u(m),v&&u(v),t==null||t(y)},updateText:(i,p)=>{const d=s.get(i);d.data=p,d.version+=1,u(d)}}),n&&this.implement(this.root,n);function u(i){const p=a.get(i.id);if(p)for(const d of p)d(i)}function l(i,p){let d;switch(i.type){case Ee:case be:{const{id:c,type:m,data:b}=i;d={id:c,type:m,data:b,version:0};break}case _e:{const{id:c,type:m,element:b,children:y,properties:v,attributes:w,eventListeners:P}=i;e==null||e(v),e==null||e(P);const R=[];d={id:c,type:m,element:b,version:0,children:R,properties:{...v},attributes:{...w},eventListeners:{...P}};for(const W of y)R.push(l(W,d));break}default:throw new Error(`Unknown node type: ${JSON.stringify(i)}`)}return s.set(d.id,d),o.set(d.id,p.id),d}function h(i){if(s.delete(i.id),o.delete(i.id),t&&("properties"in i&&t(i.properties),"eventListeners"in i&&t(i.eventListeners)),"children"in i)for(const p of i.children)h(p)}}get({id:e}){return this.attached.get(e)}implement({id:e},t){t==null?this.implementations.delete(e):this.implementations.set(e,t)}subscribe({id:e},t,{signal:n}={}){let s=this.subscribers.get(e);s==null&&(s=new Set,this.subscribers.set(e,s)),s.add(t),n==null||n.addEventListener("abort",()=>{s.delete(t),s.size===0&&this.subscribers.delete(e)})}}const ye=new WeakMap,Z=new WeakMap,Te=new WeakMap;class Qe{constructor({root:e,retain:t,release:n,call:s,cache:o}={}){F(this,"attached",new Map);this.root=e??document.createDocumentFragment();const{attached:a}=this,u=new Map;this.connection=ve({call:(i,p,...d)=>{const c=i===$&&this.root.nodeType!==11?this.root:a.get(i);return s?s(c,p,...d):c[p](...d)},insertChild:(i,p,d)=>{const c=i===$?this.root:a.get(i),m=u.get(i);m&&clearTimeout(m),c.insertBefore(l(p),c.childNodes[d]||null)},removeChild:(i,p)=>{const c=(i===$?this.root:a.get(i)).childNodes[p];if(c.remove(),o!=null&&o.maxAge){const m=u.get(i);m&&clearTimeout(m);const b=setTimeout(()=>{h(c)},o.maxAge);u.set(i,b)}else h(c)},updateProperty:(i,p,d,c=B)=>{const m=a.get(i);t==null||t(d);const b=Z.get(m),y=b[p];b[p]=d,X(m,p,d,c),n==null||n(y)},updateText:(i,p)=>{const d=a.get(i);d.data=p}});function l(i){const p=a.get(i.id);if(p)return p;let d;switch(i.type){case _e:{if(d=document.createElement(i.element),i.properties){Z.set(d,i.properties);for(const c of Object.keys(i.properties)){const m=i.properties[c];t==null||t(m),X(d,c,m,B)}}else Z.set(d,{});if(i.attributes)for(const c of Object.keys(i.attributes)){const m=i.attributes[c];t==null||t(m),X(d,c,m,te)}if(Te.set(d,{}),i.eventListeners)for(const c of Object.keys(i.eventListeners)){const m=i.eventListeners[c];t==null||t(m),X(d,c,m,re)}for(const c of i.children)d.appendChild(l(c));break}case Ee:{d=document.createTextNode(i.data);break}case be:{d=document.createComment(i.data);break}default:throw new Error(`Unknown node type: ${JSON.stringify(i)}`)}return ye.set(d,i.id),a.set(i.id,d),d}function h(i){const p=ye.get(i);p&&a.delete(p);const d=Z.get(i);if(d&&n&&n(d),i instanceof Element)for(const c of i.childNodes)h(c)}}connect(e){const t=this.root;this.root=e,t.childNodes.forEach(n=>{e.appendChild(n)})}disconnect(){if(this.root.nodeType===11)return this.root;const e=this.root,t=new DocumentFragment;return this.root=t,e.childNodes.forEach(n=>{t.appendChild(n)}),t}}function X(r,e,t,n){switch(n){case B:{r[e]=t;break}case te:{t==null?r.removeAttribute(e):r.setAttribute(e,t);break}case re:{const s=Te.get(r),o=s==null?void 0:s[e];if(o&&r.removeEventListener(e,o),t!=null){const a=u=>{var h;if(u.target!==r)return;const l=t(u.detail);(h=u.resolve)==null||h.call(u,l)};s&&(s[e]=a),r.addEventListener(e,a)}break}}}function ne(r,e){const[t,n]=_.useState(()=>{const o=e.get(r);return{id:r.id,version:o==null?void 0:o.version,value:o,receiver:e}});let s=t.value;if(t.receiver!==e||t.id!==r.id){const o=e.get(r);s=o,n({receiver:e,id:r.id,version:o==null?void 0:o.version,value:s})}return _.useDebugValue(s),_.useEffect(()=>{const o=new AbortController,a=()=>{o.signal.aborted||n(u=>{const{id:l,version:h,receiver:i}=u,{id:p}=r;if(i!==e||l!==p)return u;const d=e.get(r),c=d==null?void 0:d.version;return h===c?u:{receiver:e,value:d,id:p,version:c}})};return e.subscribe(r,a,{signal:o.signal}),a(),()=>{o.abort()}},[e,r.id]),s}function et({remote:r,receiver:e}){const t=ne(r,e);return t?f.jsx(f.Fragment,{children:t.data}):null}function oe(r,{receiver:e,components:t}){switch(r.type){case 1:{const n=t.get(r.element);if(n==null)throw new Error(`No component found for remote element: ${r.element}`);return f.jsx(n,{element:r,receiver:e,components:t},r.id)}case 3:return f.jsx(et,{remote:r,receiver:e},r.id);case 8:return null;default:throw new Error(`Unknown remote node type: ${String(r)}`)}}function tt(r,e){if(!r)return;const{children:t,properties:n,attributes:s,eventListeners:o}=r,a=[],u={...n,...s,children:a};if(e.eventProps)for(const[l,h]of Object.entries(e.eventProps)){const i=h==null?void 0:h.event;if(i==null)continue;const p=o[i];p&&(u[l]=ge(p))}else for(const[l,h]of Object.entries(o))u[`on${l[0].toUpperCase()}${l.slice(1)}`]=ge(h);for(const l of t)if(l.type===1&&typeof l.attributes.slot=="string"){const h=l.attributes.slot,i=oe(l,e);u[h]=u[h]?f.jsxs(f.Fragment,{children:[u[h],i]}):i}else a.push(oe(l,e));return u}function ge(r){return function(...t){if(t.length===1&&t[0]instanceof Event){const n=t[0];return n.target!==n.currentTarget?void 0:"detail"in n?r(n.detail):r()}return r(...t)}}const rt=Symbol.for("remote-dom.element"),nt=Symbol.for("remote-dom.element.attached");function ot(r,{name:e,eventProps:t}={}){const n=_.memo(function({element:o,receiver:a,components:u}){const l=_.useRef(),h=ne(o,a),i=h??o,p=i.id,d=tt(i,{receiver:a,components:u,eventProps:t});if(d[rt]=i,d[nt]=h!=null,l.current==null){const c={id:p,receiver:a};c.instanceRef=it(c),l.current=c}return l.current.id=p,l.current.receiver=a,_.useEffect(()=>{var m;const c={id:p};return a.implement(c,(m=l.current)==null?void 0:m.instanceRef.current),()=>{a.implement(c,null)}},[p,a]),f.jsx(r,{ref:l.current.instanceRef,...d})});return n.displayName=e??`RemoteComponentRenderer(${r.displayName??r.name??"Component"})`,n}function it(r){let e=null;return{get current(){return e},set current(t){e=t,r.receiver.implement(r,t)}}}function st(r){const{receiver:e}=r,{children:t}=ne(e.root,e);return f.jsx(f.Fragment,{children:t.map(n=>oe(n,r))})}const at=`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
</head>
...
</html>`,Re=1,Me=2,Se=3,we=4,Ae=5,Ie=Symbol.for("quilt.threads.serialize"),lt=Symbol.for("quilt.threads.transferable");class ct extends AbortController{constructor(...e){super();const t=e.find(n=>n.aborted);if(t)this.abort(t.reason);else{const n=o=>this.abort(o.target.reason),s={signal:this.signal};for(const o of e)o.addEventListener("abort",n,s)}}}class Ne extends Error{constructor(){super("You attempted to call a function on a closed thread.")}}let dt="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";function Pe(r=21){let e="",t=crypto.getRandomValues(new Uint8Array(r));for(let n=0;n<r;n++)e+=dt[63&t[n]];return e}class ut{constructor(){I(this,J);I(this,j,new Map);I(this,z,new Map);I(this,Y,new Map);I(this,K,new WeakMap)}get(e){return T(this,z).get(e)}release(e){const t=T(this,z).get(e);return t&&(T(this,z).delete(e),T(this,j).delete(t)),!!t}serialize(e){let t=T(this,j).get(e);return t==null&&(t=Pe(),T(this,j).set(e,t),T(this,z).set(t,e)),t}deserialize(e,t){var s,o;let n=(s=T(this,Y).get(e))==null?void 0:s.deref();return n||(n=(...a)=>{if(!T(this,Y).has(e))throw new Error("You attempted to call a function that was already revoked.");return t.call((u,l,h)=>{t.messages.send([Se,u,e,l],h)},a)},(o=g(this,J,je).call(this,t))==null||o.register(n,e),T(this,Y).set(e,new WeakRef(n)),n)}}j=new WeakMap,z=new WeakMap,Y=new WeakMap,K=new WeakMap,J=new WeakSet,je=function(e){let t=T(this,K).get(e);if(!(typeof FinalizationRegistry>"u"))return t||(t=new FinalizationRegistry(n=>{e.messages.send([Ae,n])}),T(this,K).set(e,t)),t};function pt(r){return r!=null&&(Symbol.asyncIterator in r||Symbol.iterator in r)&&typeof r.next=="function"}function Oe(r){if(r==null||typeof r!="object")return!1;const e=Object.getPrototypeOf(r);return e==null||e===Object.prototype}const ie="_@f",De="_@i";class mt{constructor(e){I(this,S);I(this,G);I(this,V);Q(this,G,e==null?void 0:e.serialize),Q(this,V,e==null?void 0:e.deserialize)}serialize(e,t,n){return g(this,S,ee).call(this,e,t,n)}deserialize(e,t){return g(this,S,L).call(this,e,t)}}G=new WeakMap,V=new WeakMap,S=new WeakSet,ee=function(e,t,n,s=new Map,o=!1){if(e==null)return e;if(s.has(e))return s.get(e);if(s.set(e,void 0),typeof e=="object"){if(T(this,G)&&!o){const l=T(this,G).call(this,e,h=>g(this,S,ee).call(this,h,t,n,s,!0),t,n);if(l!==void 0)return s.set(e,l),l}if(e[lt])return n==null||n.push(e),s.set(e,e),e;const a=l=>g(this,S,ee).call(this,l,t,n,s);if(typeof e[Ie]=="function"){const l=e[Ie]({serialize:a});return s.set(e,l),l}if(Array.isArray(e)){const l=e.map(h=>a(h));return s.set(e,l),l}if(e instanceof Map){const l=[...e.entries()].map(([i,p])=>[a(i),a(p)]),h=new Map(l);return s.set(e,h),h}if(e instanceof Set){const l=[...e].map(i=>a(i)),h=new Set(l);return s.set(e,h),h}const u=pt(e);if(Oe(e)||u){const l={};for(const h of Object.keys(e))l[h]=a(e[h]);return u&&(l.next??(l.next=a(e.next.bind(e))),l.return??(l.return=a(e.return.bind(e))),l.throw??(l.throw=a(e.throw.bind(e))),l[De]=!0),s.set(e,l),l}}if(typeof e=="function"){const a=t.functions.serialize(e,t,n),u={[ie]:a};return s.set(e,u),u}return s.set(e,e),e},L=function(e,t,n=!1){if(e==null)return e;if(typeof e=="object"){if(T(this,V)&&!n){const o=T(this,V).call(this,e,a=>g(this,S,L).call(this,a,t,!0),t);if(o!==void 0)return o}if(e==null)return e;if(Array.isArray(e))return e.map(o=>g(this,S,L).call(this,o,t));if(e instanceof Map)return new Map([...e].map(([o,a])=>[g(this,S,L).call(this,o,t),g(this,S,L).call(this,a,t)]));if(e instanceof Set)return new Set([...e].map(o=>g(this,S,L).call(this,o,t)));if(ie in e)return t.functions.deserialize(e[ie],t);if(!Oe(e))return e;const s={};for(const o of Object.keys(e))o===De?s[Symbol.asyncIterator]=()=>s:s[o]=g(this,S,L).call(this,e[o],t);return s}return e};class ft{constructor(e,{imports:t,exports:n,functions:s=new ut,serialization:o=new mt,signal:a}={}){I(this,A);I(this,x);I(this,D,new Map);var u,l,h,i;this.messages=e,Q(this,x,a?new ct(a):new AbortController),this.exports=n??{},this.imports=ht(g(this,A,Ye).bind(this),t),this.functions=s,this.serialization=o,(l=(u=this.functions).start)==null||l.call(u,this),(i=(h=this.serialization).start)==null||i.call(h,this),this.signal.addEventListener("abort",()=>{for(const p of T(this,D).keys())g(this,A,de).call(this,p,void 0,new Ne);T(this,D).clear()},{once:!0}),e.listen(async p=>{if(!(Array.isArray(p)&&typeof p[0]=="number"))return;const c=p;switch(c[0]){case Re:{const[,m,b,y]=c,v=this.exports[b]??(()=>{throw new Error(`No '${b}' method is exported from this thread`)});await g(this,A,ce).call(this,v,y,(w,P,R)=>{this.messages.send([Me,m,w,P],R)});break}case Se:{const[,m,b,y]=c,v=this.functions.get(b,this)??_t;await g(this,A,ce).call(this,v,y,(w,P,R)=>{this.messages.send([we,m,w,P],R)});break}case Me:case we:{g(this,A,de).call(this,...c.slice(1));break}case Ae:{const m=c[1];this.functions.release(m,this);break}}},{signal:this.signal})}get signal(){return T(this,x).signal}get closed(){return T(this,x).signal.aborted}close(){T(this,x).abort()}call(e,t){if(this.closed)return Promise.reject(new Ne);const n=[],s=this.serialization.serialize(t,this,n),o=Pe(),a=g(this,A,Ge).call(this,o);return e(o,s,n),a}}x=new WeakMap,D=new WeakMap,A=new WeakSet,ce=async function(e,t,n){try{const s=this.functions.call?await this.functions.call(e,t,this):await e(...this.serialization.deserialize(t,this)),o=[],a=this.serialization.serialize(s,this,o);n(a,void 0,o)}catch(s){n(void 0,this.serialization.serialize(s,this))}},Ye=function(e){return(...t)=>{try{if(typeof e!="string"&&typeof e!="number")throw new Error(`Can’t call a symbol method on a thread: ${e.toString()}`);return this.call((n,s,o)=>{this.messages.send([Re,n,e,s],o)},t)}catch(n){return Promise.reject(n)}}},de=function(...e){const t=e[0],n=T(this,D).get(t);n&&(n(...e),T(this,D).delete(t))},Ge=function(e){const t=new Promise((n,s)=>{T(this,D).set(e,(o,a,u)=>{u==null?n(this.serialization.deserialize(a,this)):s(this.serialization.deserialize(u,this))})});return Object.defineProperty(t,Symbol.asyncIterator,{async*value(){const n=await t;Object.defineProperty(n,Symbol.asyncIterator,{value:()=>n}),yield*n}}),t};function ht(r,e){let t;if(e==null){if(typeof Proxy!="function")throw new Error("You must pass an array of callable methods in environments without Proxies.");const n=new Map;t=new Proxy({},{get(s,o){if(n.has(o))return n.get(o);const a=r(o);return n.set(o,a),a}})}else{t={};for(const n of e)Object.defineProperty(t,n,{value:r(n),writable:!1,configurable:!0,enumerable:!0})}return t}function _t(){throw new Error("You attempted to call a function that is not stored. It may have already been released.")}const Et="quilt.threads.ping",Ce="quilt.threads.pong";function bt(r,{targetOrigin:e="*"}={}){let t=!1;const n=function(a,u){r.postMessage(a,e,u)},s=new Promise(o=>{const a=new AbortController;globalThis.window.addEventListener("message",u=>{u.source===r&&u.data===Ce&&(t=!0,a.abort(),o())},{signal:a.signal}),a.signal.addEventListener("abort",()=>o(),{once:!0}),n(Et)});return{send(o,a){return t?n(o,a):s.then(()=>{if(t)return n(o,a)})},listen(o,{signal:a}){self.addEventListener("message",u=>{u.source===r&&u.data!==Ce&&o(u.data)},{signal:a})}}}class vt extends ft{constructor(e,{targetOrigin:t="*",...n}={}){super(bt(e.contentWindow,{targetOrigin:t}),n),this.iframe=e}}const Le=_.forwardRef(({content:r,children:e,...t},n)=>f.jsx("span",{ref:n,...t,children:r||e}));Le.displayName="UIText";const Ue=_.forwardRef(({label:r,onPress:e,onClick:t,children:n,...s},o)=>{const a=u=>{e&&e(),t&&t(u)};return f.jsx("button",{ref:o,onClick:a,style:{padding:"8px 16px",backgroundColor:"#007bff",color:"white",border:"none",borderRadius:"4px",cursor:"pointer"},...s,children:r||n})});Ue.displayName="UIButton";const ze=_.forwardRef(({direction:r="vertical",spacing:e="8",align:t="stretch",justify:n="flex-start",children:s,...o},a)=>f.jsx("div",{ref:a,style:{display:"flex",flexDirection:r==="horizontal"?"row":"column",gap:`${e}px`,alignItems:t,justifyContent:n},...o,children:s}));ze.displayName="UIStack";const xe=_.forwardRef(({src:r,alt:e,width:t,height:n,children:s,...o},a)=>f.jsx("img",{ref:a,src:r,alt:e,width:t,height:n,style:{maxWidth:"100%",height:"auto",borderRadius:"8px",boxShadow:"0 2px 8px rgba(0, 0, 0, 0.1)"},...o}));xe.displayName="UIImage";const se={name:"basic",elements:[{tagName:"ui-text",component:Le,propMapping:{content:"content"},eventMapping:{}},{tagName:"ui-button",component:Ue,propMapping:{label:"label"},eventMapping:{press:"onPress"}},{tagName:"ui-stack",component:ze,propMapping:{direction:"direction",spacing:"spacing",align:"align",justify:"justify"},eventMapping:{}},{tagName:"ui-image",component:xe,propMapping:{src:"src",alt:"alt",width:"width",height:"height"},eventMapping:{}}]},yt=({receiver:r})=>{const e=_.useRef(null);return _.useEffect(()=>{if(e.current)return r.connect(e.current),()=>{r.disconnect()}},[r]),f.jsx("div",{ref:e,"data-testid":"standard-dom-renderer-container"})},Tt=({resource:r,library:e,remoteElements:t=[],onUIAction:n})=>{const s=_.useRef(null),o=_.useRef(null),[a,u]=_.useState(null),l=_.useMemo(()=>(r.mimeType||"").includes("framework=react")?"react":"webcomponents",[r.mimeType]),h=`${e==null?void 0:e.name}-${l}`,{receiver:i,components:p}=_.useMemo(()=>{switch(l){case"react":{const c=new Je,m=e||se,b=new Map;return m&&m.elements.forEach(y=>{const v=ot(y.component);b.set(y.tagName,v)}),{receiver:c,components:b}}case"webcomponents":default:return{receiver:new Qe,components:null}}},[r,e,t]);_.useEffect(()=>{function c(m){var b;if(s.current&&m.source===s.current.contentWindow){const y=m.data;if(!y)return;(b=n==null?void 0:n(y))==null||b.catch(v=>{console.error("Error handling UI action result in RemoteDOMResourceRenderer:",v)})}}return window.addEventListener("message",c),()=>window.removeEventListener("message",c)},[n]),_.useEffect(()=>{const c=o.current;return o.current=null,()=>{c==null||c.close()}},[h]);const d=()=>{const c=s.current;if(!c||o.current)return;const m=new vt(c);o.current=m;const{code:b,error:y}=He(r);if(y){u(y);return}if(b&&(i!=null&&i.connection)){const v={code:b,remoteElements:t,useReactRenderer:l==="react",componentLibrary:e==null?void 0:e.name};m.imports.render(v,i.connection).catch(w=>console.error("Error calling remote render:",w))}};return a?f.jsx("p",{className:"text-red-500",children:a}):f.jsxs(f.Fragment,{children:[f.jsx("iframe",{ref:s,srcDoc:at,sandbox:"allow-scripts",style:{display:"none"},title:"Remote DOM Sandbox",onLoad:d},h),l==="react"&&p?f.jsx(st,{receiver:i,components:p}):f.jsx(yt,{receiver:i})]})};function gt(r){var e;if(r.contentType)return r.contentType;if(r.mimeType==="text/html")return"rawHtml";if(r.mimeType==="text/uri-list")return"externalUrl";if((e=r.mimeType)!=null&&e.startsWith("application/vnd.mcp-ui.remote-dom"))return"remoteDom"}const ke=r=>{const{resource:e,onUIAction:t,supportedContentTypes:n,htmlProps:s,remoteDomProps:o}=r,a=gt(e);if(n&&a&&!n.includes(a))return f.jsxs("p",{className:"text-red-500",children:["Unsupported content type: ",a,"."]});switch(a){case"rawHtml":case"externalUrl":return f.jsx(fe,{resource:e,onUIAction:t,...s});case"remoteDom":return f.jsx(Tt,{resource:e,onUIAction:t,library:(o==null?void 0:o.library)||se,...o});default:return f.jsx("p",{className:"text-red-500",children:"Unsupported resource type."})}};ke.displayName="UIResourceRenderer";function Rt(r){var e,t;return(r.type==="resource"&&((t=(e=r.resource)==null?void 0:e.uri)==null?void 0:t.startsWith("ui://")))??!1}const Mt={tagName:"ui-card"},St={tagName:"ui-button",remoteAttributes:["label"],remoteEvents:["click","press"]},wt={tagName:"ui-text",remoteAttributes:["content"]},At={tagName:"ui-stack",remoteAttributes:["direction","spacing","align","justify"]},It={tagName:"ui-image",remoteAttributes:["src","alt","width","height"]};E.UIResourceRenderer=ke,E.basicComponentLibrary=se,E.getResourceMetadata=pe,E.getUIResourceMetadata=me,E.isUIResource=Rt,E.remoteButtonDefinition=St,E.remoteCardDefinition=Mt,E.remoteImageDefinition=It,E.remoteStackDefinition=At,E.remoteTextDefinition=wt,Object.defineProperty(E,Symbol.toStringTag,{value:"Module"})});
