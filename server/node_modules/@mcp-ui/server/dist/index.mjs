const o = "mcpui.dev/ui-", d = `var __defProp = Object.defineProperty;
...
function i(e) {
  ...
  if (e.uiMetadata || e.metadata) {
    const t = Object.fromEntries(
      Object.entries(e.uiMetadata ?? {}).map(([a, s]) => [
        `${o}${a}`,
        s
      ])
    );
...
function p(e) {
  ...
  if (typeof TextEncoder < "u" && typeof btoa < "u") {
    ...
    for (let r = 0; r < t.length; r += s)
      a += String.fromCharCode(...t.slice(r, r + s));
    return btoa(a);
  } else {
    console.warn(
...
function u(e) {
  ...
  if (e.content.type === "rawHtml") {
    ...
    e.adapters ? (n = c(n, e.adapters), t = l(e.adapters) ?? "text/html") : t = "text/html";
    ...
    t = `application/vnd.mcp-ui.remote-dom+javascript; framework=${e.content.framework}`;
  } else {
    const s = e.content;
